...
// import PgBuy from 'Common/pages/PgBuy'
...
//         let { getBankCard, getProInfo, getAgreementList, apiQueryPrdInfo, getApiQueryPurchaseCount, initTradingStatus } = this.Store
